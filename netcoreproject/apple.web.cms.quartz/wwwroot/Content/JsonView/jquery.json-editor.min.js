!function () {
    ...
    function n(e, r,rk) {
        var vtxt = '',editcss='',openEdit='';
        if (e != "Content" && rk == "value") {
            vtxt = e + '<i class="layui-icon layui-icon-edit"></i>';
            editcss = 'edit-span-cee', openEdit = "onclick=\"WKFXCms.JsonOpen(this)\"";
        }
        else {
            vtxt = e;
            editcss = '', openEdit='';
            ...
            var s = "";
        if ("string" == typeof e) e = e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;"),
            s += t(e) ? '<a href="' + e + '" class="json-string json-url">"' + e + '"</a>' : '<span class="json-string ' + editcss + '" ' + openEdit+'>"' + vtxt+ '"</span>';
        else if ("number" == typeof e) s += '<span class="json-literal json-literal-number ' + editcss +'">' + vtxt + "</span>";
        else if ("boolean" == typeof e) s += '<span class="json-literal json-literal-boolean ' + editcss +'">' + vtxt + "</span>";
            else if (null === e) s += '<span class="json-literal json-literal-null">null</span>';
        else if (e instanceof Array) if (e.length > 0) {
            s += '[<i class="layui-icon layui-icon-add-1 icon-add-json" onclick="addJsonArea(this)"></i><ol class="json-array">';
            ...
            return r = r || {},
                this.each(function () {
                    ...
                    o(t) && (s = '<a href class="json-toggle"></a>' + s),
                        ...
                        e(this).on("click", "a.json-placeholder",
                            function () {
    ...
    function (e) {
        ...
        n.prototype = {
            ...
            get: function () {
                try {
                    return this.$container.find(".collapsed").click(),
