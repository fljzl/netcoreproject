...
; layui.define("view", function (e) {
    var a = layui.jquery
        ...
        , x = {
            ...
            sideFlexible: function (e) {
                ...
                if (e == 'spread') {
                    a("#layui-dao").removeClass("munu-daohan-40").addClass("munu-daohan-240");
                }
                else
                    a("#layui-dao").removeClass("munu-daohan-240").addClass("munu-daohan-40");
            },
            escape: function (e) {
    ...
    o.on("click", z, function () {
        ...
        //a("#LAY_app").addClass("layadmin-side-shrink");
        //a("#LAY_app_flexible").removeClass("layui-icon-shrink-right").addClass("layui-icon-spread-left");
        //a("#layui-dao").removeClass("munu-daohan-240").addClass("munu-daohan-40");
        ...
        setTimeout(function () {
            ...
            var _dap = '<a href="/Pro">首页</a>';
            var vpname = e.attr("pname");
            var vtpname = e.attr("ptname");
            if (vpname != '' && vpname != undefined)
                _dap += '<span lay-separator="">/</span><cite>' + vpname + '</cite>';
            if (vtpname != '' && vtpname != undefined)
            _dap += '<span lay-separator="">/</span><cite>' + vtpname + '</cite>';
        _dap += '<span lay-separator="">/</span><cite>' + e.text() + '</cite>';
        a("#layui-dao").html(_dap);
        }),
